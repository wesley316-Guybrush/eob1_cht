...
OUT = Path("/mnt/d/03_game_tmp/eob1_cht/test-reports/font-preview/preview_14x14_resample.png")
...
dr.text((20, 8), f"ceob 14×14 preview (Unifont 16×16 bicubic resample, {len(glyphs)} glyphs, thr=110)", fill=(255,220,120))
y = 36
for s in samples:
    cx = 20
    for cp in cps(s):
